        ...
        <main className={""}>
            ...
            <section
                ...
                <div onClick={() => navigate(-1)}
                     className={"text-2xl my-5 text-zinc-500 hover:text-zinc-300 cursor-pointer "}>
                    <AiOutlineArrowLeft/>
                </div>

                {/* Card Upper */}
                <article className={"flex justify-between bg-zinc-800"}>
                    {/*Image*/}
                    <div className={"bg-zinc-400 w-full basis-3/5"}></div>
                    ...
                    <div className={"basis-2/5 p-6 flex flex-col justify-between space-y-12"}
                        ...
                        <div>
                            ...
                            <div className={"flex justify-between items-center"}>
                                ...
                                <p className={"font-bold text-sm text-zinc-500"}>July 22, 2022</p>
                            </div>
                            {/* Title */}
                            <h1 className={"mt-5 text-3xl font-bold text-sky-300"}>Festival at Soest during Weekend</h1>

                            {/* Description */}
                            <p className={"text-sm mt-4 font-semibold text-justify text-zinc-500"}>
                        ...
                        <div className={"space-y-5"}>
                            <div className={"flex justify-between items-center"}>
                                <ProfileBadge/>
                                <button
                                    className={"text-sm font-semibold py-2 px-4 bg-zinc-700 text-zinc-50 rounded-md shadow-zinc-900 hover:bg-sky-500 transition-all"}>Join
                                    now
                                </button>
                            </div>
                ...
                <article className={"flex justify-between mt-10 space-x-5"}>
                    {/*Instruction*/}
                    <div className={"basis-3/5 p-10 bg-zinc-800"}>
                    ...
                    {/*Location*/}
                    <div className={"basis-2/5 bg-zinc-800 p-8 text-center"}>
